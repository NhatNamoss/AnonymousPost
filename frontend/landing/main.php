...
<body class="font-sans bg-gray-50">
    <!-- Hero Section -->
    <section id="hero" class="hero-section text-white min-h-screen flex items-center relative overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="publication-card bg-white rounded-xl overflow-hidden shadow-md transition duration-300" data-aos="zoom-in">
                    ...
                    <div class="p-6">
                        ...
                        <a href="tap-chi-tin-hoc.html" class="text-blue-500 font-medium inline-flex items-center">
                            Xem thêm
                ...
                <div class="publication-card bg-white rounded-xl overflow-hidden shadow-md transition duration-300" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="p-6">
                        ...
                        <a href="ebook-lap-trinh.html" class="text-blue-500 font-medium inline-flex items-center">
                            Xem thêm
                            <i data-feather="arrow-right" class="ml-2 w-4 h-4"></i>
                        </a>
                    </div>
                ...
                <div class="publication-card bg-white rounded-xl overflow-hidden shadow-md transition duration-300" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <div class="p-6">
                        ...
                        <a href="video-tutorial.html" class="text-blue-500 font-medium inline-flex items-center">
                            Xem thêm
                            <i data-feather="arrow-right" class="ml-2 w-4 h-4"></i>
                        </a>
                    </div>
