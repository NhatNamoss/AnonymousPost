...
<head>
    ...
    <title>E-book Python - CLB Tin Học</title>
    ...
    <style>
        ...
        .level-easy { background: linear-gradient(45deg, #10b981, #059669); }
        .level-medium { background: linear-gradient(45deg, #f59e0b, #d97706); }
        .level-hard { background: linear-gradient(45deg, #ef4444, #dc2626); }
        .breadcrumb {
            color: #6b7280;
        }
        .breadcrumb a:hover {
...
<body class="font-sans bg-gray-50">
    ...
    <!-- Hero Section -->
    <section class="hero-section text-white pb-16">
