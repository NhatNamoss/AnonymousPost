...
<head>
    ...
    <title>Tạp chí Tin học - CLB Tin Học</title>
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-6">
                    ...
                    <a href="ebook-lap-trinh.html" class="text-gray-600 hover:text-blue-600 transition">E-book Lập trình</a>
                    <a href="tap-chi-tin-hoc.html" class="text-blue-600 font-medium active">Tạp chí Tin học</a>
