    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="ebook.php" class="text-gray-400 hover:text-white transition">E-books</a></li>
                    <li><a href="video.php" class="text-gray-400 hover:text-white transition">Video Tutorial</a></li>
                    <li><a href="tapchi.php" class="text-gray-400 hover:text-white transition">Tạp chí</a></li>
...
<script>
    ...
    // Vanta.js script chỉ cho trang main
